...
- **No arbitrary effort input** — the composer slider offers only the exact model's adapter-advertised levels in adapter order; an adapter without reasoning metadata leaves the Effort row absent.
